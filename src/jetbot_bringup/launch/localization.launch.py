...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('jetbot_bringup')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'map',
            default_value=os.path.join(bringup_dir, 'maps', 'map_maze_1.yaml'),
        ...
        DeclareLaunchArgument(
            'params_file',
            default_value=os.path.join(bringup_dir, 'config', 'nav2_default_params.yaml'),
