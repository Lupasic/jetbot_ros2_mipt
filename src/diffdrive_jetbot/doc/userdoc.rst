...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch diffdrive_jetbot view_robot.launch.py
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [DiffDriveJetbotHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [DiffDriveJetbotHardware]: Got command 50.00000 for 'right_wheel_joint'!
